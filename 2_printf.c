...
/**
 * print_hexa_upper - Funtion that prints an unsigned number in upper hexadecimal notation
 * @types: List of arguments
 * @buffer: Buffer array to handle print
 * @flags:  Calculates active flags
 * @width: get width
...
/**
 * print_hexa - Function thatrints a hexadecimal number in lower or upper
 * @types: List of arguments
